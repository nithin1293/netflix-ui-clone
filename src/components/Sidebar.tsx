...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      <aside className="desktop-sidebar fixed left-0 top-0 z-50 h-screen w-16 flex-col items-center bg-sidebar py-6">
        {/* Logo */}
        <div className="mb-8">
      ...
      <nav className="mobile-nav fixed bottom-0 left-0 right-0 z-50 h-16 items-center justify-around border-t border-border/20 bg-sidebar/95 backdrop-blur-lg">
